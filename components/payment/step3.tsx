...
const Step3 = ({ onFinish }: any) => {
  return (
    <div className='pb-10'>
      <div className='grid gap-y-[25px] border border-slate-300 rounded-[10px] p-5 mt-[30px]' style={{boxShadow: '0 -1px 4px rgba(0,0,0,.04), 0 4px 8px rgba(0,0,0,.08)'}}>
        ...
        <div className='flex items-center font-bold justify-between text-3xl'>
          ...
          {/* <div className='text-xl bg-primary text-white text-bold rounded-[10px] px-5 py-2.5 flex items-center'>
          <div className='mr-5'>
            <CheckCircleFilled className='text-3xl'/>
          </div>
          <div className='w-full'>Terkonfirmasi</div>
        </div> */}
          {/* kasih kondisi jika gagal akan tampil ini */}
          {/* <div className='text-xl bg-merah text-white text-bold rounded-[10px] px-5 py-2.5 flex items-center'>
          <div className='mr-5'>
            <CloseCircleFilled className='text-3xl'/>
          </div>
          <div className='w-full'>Dibatalkan</div>
        </div> */}
          {/* kasih kondisi jika pending akan tampil ini */}
          <div className='text-xl bg-[#FFCC00] text-white text-bold rounded-[10px] px-5 py-2.5 flex items-center'>
            <div className='mr-5'>
              <ClockCircleFilled className='text-3xl' />
            </div>
            <div className='w-full'>Menunggu</div>
          </div>
        </div>
      </div>
      <div>
