...
function RenterStep2({setData, dataInput, formStep2}: Props){
    ...
    <div>
        ...
        <div className="grid gap-y-4 grid-cols-1">
            <div>
				<p className="text-teks text-2xl font-bold">Konfirmasi Kata Sandi</p>
			</div>
            <div className="w-full">
            <Form.Item
                name="confirm"
            ...
            >
                <Input.Password size="large" placeholder="Masukan kembali kata sandi" className="p-[10px] rounded-[10px] border border-rstroke regis text-xl"
                iconRender={(visible) => (visible ? <EyeTwoTone/> : <EyeInvisibleOutlined/>)}/>
            </Form.Item>
            </div>
        </div>
