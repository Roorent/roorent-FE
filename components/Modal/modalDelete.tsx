...
function ModalDelete({ title, content, icon, buttonText}: any) {
    ...
    return (
        <div className='modal-hapus'>
            <Button type="primary" onClick={showDeleteConfirm} className="hover:text-white hover:!bg-[#e24444] hapus !bg-merah rounded-[10px] text-base font-bold py-3 w-[111px] h-max">
                {buttonText}
            </Button>
        </div>
    )
