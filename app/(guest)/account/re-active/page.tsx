...
import { CameraOutlined, EyeInvisibleOutlined, EyeTwoTone, WarningFilled } from '@ant-design/icons';
                        ...
                        <Form>
                            <div className="flex gap-x-5 grid-cols-1">
                                <div className="w-1/2 grid gap-y-4 grid-cols-1">
                                    ...
                                    <div className="w-full">
                                        ...
                                        >
                                            <Input size="large" placeholder="Masukan nama depan" className=" p-[10px] rounded-[10px] border border-rstroke regis text-xl" />
                                        </Form.Item>
                                    </div>
                                </div>
                                <div className="w-1/2 grid gap-y-4 grid-cols-1">
                                    ...
                                    <div className="w-full">
                                        ...
                                        >
                                            <Input size="large" placeholder="Masukan nama belakang" className=" p-[10px] rounded-[10px] border border-rstroke regis text-xl" />
                                        </Form.Item>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid gap-y-4 grid-cols-1">
                                ...
                                <div className="w-full">
                                    ...
                                    >
                                        <Input size="large" placeholder="Masukan email" className=" p-[10px] rounded-[10px] border border-rstroke regis text-xl" />
                                    </Form.Item>
                                </div>
                            </div>
                            <div className="flex gap-x-5 grid-cols-1">
                                <div className="w-1/2 grid gap-y-4 grid-cols-1">
                                    ...
                                    <div className="w-full">
                                        ...
                                        >
                                            <Input.Password size="large" placeholder="Masukan Password" className="p-[10px] rounded-[10px] border border-rstroke regis text-xl"
                            ...
                            <div className="w-full mt-10 regis">
                                <Form.Item>
                                    <Button type="primary" htmlType="submit" block className="regis bg-primary rounded-[20px] px-8 py-2.5 text-xl font-bold h-max">
                                        Selesai
                                    </Button>
                                </Form.Item>
                            </div>
